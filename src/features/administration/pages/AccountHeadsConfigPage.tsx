            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              {!isCreating && (
                <Button
                  ...
                  className="gap-1.5 text-xs bg-indigo-900 text-white hover:bg-indigo-950 font-bold shrink-0 cursor-pointer"
                >
            ...
            <form onSubmit={handleCreate} className="bg-indigo-50/80 border border-indigo-200 rounded-2xl p-5 space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <Button
                  ...
                  className="text-xs bg-indigo-900 text-white hover:bg-indigo-950 font-bold gap-1.5 cursor-pointer"
                >
