          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold text-slate-900 tracking-tight">Restaurant POS</h1>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-5 shadow-xl flex flex-col items-center">
            ...
            <div className="flex items-center gap-3 w-full">
              ...
              <button
                ...
                className="flex-1 py-2 rounded-xl bg-indigo-600 text-white font-semibold text-xs hover:bg-indigo-700"
              >
                Print KOT Now
              </button>
            </div>
