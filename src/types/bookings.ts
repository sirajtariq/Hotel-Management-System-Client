...
export interface Booking {
  ...
  commission_recipient?: string | number | null;
  commissionRecipient?: string | number | null;
...
export interface CreateBookingInput {
  ...
  discountAmount?: number;
  commissionRecipient?: string | number | null;
  commissionRecipientId?: string | number | null;
  commission_recipient_id?: string | number | null;
  commissionAmount?: number;
  commission_amount?: number;
  taxRate?: number;
  taxAmount?: number;
